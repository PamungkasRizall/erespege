    ...
    >
        ...
        >
            ...
            >
                <div>
                    ...
                    Lihat Surat Rekomendasi Penerbitan Penugasan Klinis [Jika tidak tampil, klik <a href="{{ route('applications.credential.prints.rekomendasi-penerbitan-penugasa-klinis', ['id' => $modelId]) }}" target="_blank" class="text-primary">disini</a>]
                    </p>
                </div>
            </div>
            <button
        ...
        <div x-collapse x-show="expanded">
            <div class="px-4 py-4 sm:px-5">
                <iframe src="{{ route('applications.credential.prints.rekomendasi-penerbitan-penugasa-klinis', ['id' => $modelId]) }}?q=authorized" width="100%" height="400" frameborder="0">
