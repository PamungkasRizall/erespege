    ...
    >
        ...
        >
            ...
            >
                <div>
                    ...
                    Lihat Berita Acara [Jika tidak tampil, klik <a href="{{ route('applications.credential.prints.berita-acara', ['id' => $modelId]) }}" target="_blank" class="text-primary">disini</a>]
                    </p>
                </div>
            </div>
            <button
        ...
        <div x-collapse x-show="expanded">
            <div class="px-4 py-4 sm:px-5">
                <iframe src="{{ route('applications.credential.prints.berita-acara', ['id' => $modelId]) }}?q=authorized" width="100%" height="400" frameborder="0">
