...
>
    <div @class([
            ...
            'relative inline-block text-left z-10 w-full md:w-auto pt-2' => $component->isTailwind(),
        ])
    >
        <button
            @class([
                'btn dropdown-toggle d-block d-md-inline' => $component->isBootstrap(),
                'inline-flex justify-center px-4 py-1 w-full text-sm bg-white rounded-md border border-gray-300 shadow-sm hover:bg-gray-50 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-gray-700 dark:text-white dark:border-gray-600 dark:hover:bg-gray-600' => $component->isTailwind(),
            ])
            type="button"
