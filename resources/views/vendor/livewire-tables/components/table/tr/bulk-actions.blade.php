                ...
                <template x-if="selectedItems.length == paginationTotalItemCount">
                    <div wire:key="{{ $tableName }}-all-selected">
                        ...
                        <button
                            ...
                            type="button"
                            class="ml-1 text-blue-600 underline text-sm leading-5 font-medium focus:outline-none focus:text-gray-800 focus:underline transition duration-150 ease-in-out dark:text-white dark:hover:text-gray-400"
                        >
                            @lang('Deselect All')
                        </button>
                    </div>
